...
if (isset($_POST["submit"])) {
    ...
    if ($register_no !== false && $student_name && $hse_mark !== false && $phone_no !== false && $maths !== false && $physics !== false && $chemistry !== false && $cs1 && $cs2 && $cs3) {
        ...
        $courses = [
            ['code' => 'BE01', 'min_cutoff' => 140, 'seats' => 50],
            ['code' => 'BE02', 'min_cutoff' => 150, 'seats' => 50],
            ['code' => 'BE03', 'min_cutoff' => 165, 'seats' => 60],
            ['code' => 'BE04', 'min_cutoff' => 170, 'seats' => 60],
            ['code' => 'BE05', 'min_cutoff' => 130, 'seats' => 50],
            ['code' => 'BE06', 'min_cutoff' => 160, 'seats' => 50],
            ['code' => 'BT01', 'min_cutoff' => 175, 'seats' => 60],
            ['code' => 'BT02', 'min_cutoff' => 185, 'seats' => 60],
            ['code' => 'BT03', 'min_cutoff' => 175, 'seats' => 50],
            ['code' => 'BT04', 'min_cutoff' => 165, 'seats' => 1],
        ];
